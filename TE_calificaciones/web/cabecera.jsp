...
<header id="header" class="container-fluid">
	<div class="col-md-6"><h3>SGC</h3></div><br>
            <%
                String mensaje = (String) session.getAttribute("login");
                if (mensaje == "OK") {                               
            %>
            <div class="col-md-offset-2 col-md-4"> 
                <%= session.getAttribute("propietario") %>
            ...
            %>
<div class="col-md-offset-4 col-md-2"><a href="Controlador_usuarios?action=add">Registrarse</a></div>            
            <%
                }            
            %>	
</header>